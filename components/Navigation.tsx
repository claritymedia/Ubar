                          ...
                          {/* Logo */}
                                  <div className="flex-shrink-0 flex items-center cursor-pointer group" onClick={() => setActiveTab(Tab.RIDE)}>
                                              <div className="relative w-20 h-20 hover:scale-105 transition-transform duration-300">
                                                            <img src="/ubar-logo.png" alt="U-BAR Logo" className="w-full h-full object-contain drop-shadow-[0_0_10px_rgba(132,182,244,0.3)]" />
                                              </div>div>
                                  </div>div>
                          ...
                          {/* Desktop Menu */}
                            ...
                            <button
                              ...
                              {item.label}
                                              ...
                                              <div className="h-6 w-px bg-white/10 mx-2"></div>div>
                                              <button
                                      ...
                                      {item.label}
                                          ...
                                          <button
                                                          ...
                                                          className={`flex items-center gap-2 px-3 py-4 rounded-md text-base font-medium w-full text-left mt-2 border-t border-white/5 ${
                                                                            activeTab === Tab.DRIVER ? 'text-electric' : 'text-gray-400 hover:text-white'
                                                          }`}
                                                        >
                                                        <CarFront className="w-4 h-4" />
                                                        Driver Portal
